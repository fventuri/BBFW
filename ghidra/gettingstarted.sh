...
echo -e "\nTry running\n   $GHIDRA_INSTALL_DIR/./ghidraRun\nThen when Ghidra is running, go to File > Open Project > Home > X6100_BBFW_V1.1.6_221112001_ghidraproject.gpr > Open Project, then double-click on the .bin file in the menu."
